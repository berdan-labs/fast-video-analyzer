...
checks, generates a CycloneDX JSON SBOM for the locked runtime dependencies,
attests the package files, and creates a GitHub Release with the packages and
SBOM attached.
